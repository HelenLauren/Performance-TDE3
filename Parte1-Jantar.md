...
Assi, pelo menos um filósofo consegue pegar os dois garfos e comer, liberando os garfos para os próximos na ordem.
...
garfo[0..N-1]                        // cada garfo é um recurso exclusivo
